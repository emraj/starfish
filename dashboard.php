...
<html>
  ...
  <body>
    ...
    if (isset($email, $password, $id)){
      ...
      // Insert Snippet 1 here from snippets.txt; 'Advertising' category.
      ...
      // Insert Snippet 2 here from snippets.txt; 'E-Commerce' category.
      ...
      function selectHandler() {
        ...
        if (selectedItem) {
          ...
          if (value == 'Acquisition') {
            jQuery( document ).ready(function() {
              jQuery('#description').html('<black>USER ACQUISITION <BR> The process of persuading a consumer to purchase a company\'s goods or services. The cost associated with the important customer acquisition process is an important measure for a business to evaluate in combination with how much value having each customer typically brings to the business. </black><a href="<?php echo site_url() ?>/wp-content/plugins/starfish/dashboard_2.php">View details!</a>');
            });
          }
          else if (value == 'Usability') {
            jQuery( document ).ready(function() {
              jQuery('#description').html('<black>SITE USABILITY: The ease of use of a website.</black><a href="<?php echo site_url() ?>/wp-content/plugins/starfish/dashboard_2.php">View details!</a>');
            });
          }
          else if (value == 'Engagement') {
            jQuery( document ).ready(function() {
              jQuery('#description').html('<black>USER ENGAGEMENT <BR> The engagement of customers with one another, with a company or a brand.</black> <a href="<?php echo site_url() ?>/wp-content/plugins/starfish/dashboard_2.php">View details!</a>');
            });
          }
        }
      }
